package com.witalis.praxis.leetcode.task.h7.p607;

import com.witalis.praxis.leetcode.task.LeetCodeTask;
import com.witalis.praxis.leetcode.task.h7.p607.option.*;
...
public class SalesPerson extends LeetCodeTask<String> {
    ...
    public SalesPerson(int id, String description, TaskRevision revision) {
        super(id, description, revision);
        initialization();
    }

    private void initialization() {
        this.sales = Collections.emptyList();

        log.info("Sales are {}", sales);
    }
