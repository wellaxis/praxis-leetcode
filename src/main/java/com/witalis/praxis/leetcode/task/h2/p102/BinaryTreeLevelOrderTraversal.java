package com.witalis.praxis.leetcode.task.h2.p102;

import com.witalis.praxis.leetcode.task.LeetCodeTask;
import com.witalis.praxis.leetcode.task.h2.p102.content.*;
import com.witalis.praxis.leetcode.task.h2.p102.option.*;
...
public class BinaryTreeLevelOrderTraversal extends LeetCodeTask<List<List<Integer>>> {
    ...
    public BinaryTreeLevelOrderTraversal(int id, String description, TaskRevision revision) {
