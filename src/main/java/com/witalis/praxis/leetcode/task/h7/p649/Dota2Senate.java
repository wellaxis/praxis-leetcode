package com.witalis.praxis.leetcode.task.h7.p649;

import com.witalis.praxis.leetcode.task.LeetCodeTask;
import com.witalis.praxis.leetcode.task.h7.p649.option.*;
...
public class Dota2Senate extends LeetCodeTask<String> {
    ...
    public Dota2Senate(int id, String description, TaskRevision revision) {
    ...
    private void initialization() {
        ...
        for (int i = 0; i < len; i++) {
            builder.append(random.nextBoolean() ? 'R' : 'D');
        }
        this.senate = builder.toString();

        log.info("Senate: '{}'", senate);
    }
    ...
    protected String original() {
        var original = new Original(senate);
    ...
    protected String practice() {
        var practice = new Practice(senate);
    ...
    protected String solution() {
        var solution = new Solution(senate);
