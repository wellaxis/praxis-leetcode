package com.witalis.praxis.leetcode.task.p30;

import com.witalis.praxis.leetcode.task.LeetCodeTask;
import com.witalis.praxis.leetcode.task.p30.option.*;
...
@Slf4j
@LeetCode(id = 30, description = "Substring with Concatenation of All Words")
