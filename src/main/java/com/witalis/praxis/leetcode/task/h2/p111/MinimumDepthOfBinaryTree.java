package com.witalis.praxis.leetcode.task.h2.p111;

import com.witalis.praxis.leetcode.task.LeetCodeTask;
import com.witalis.praxis.leetcode.task.h2.p111.content.*;
import com.witalis.praxis.leetcode.task.h2.p111.option.*;
...
public class MinimumDepthOfBinaryTree extends LeetCodeTask<Integer> {
    ...
    public MinimumDepthOfBinaryTree(int id, String description, TaskRevision revision) {
