package com.witalis.praxis.leetcode.task.p2;

import com.witalis.praxis.leetcode.task.LeetCodeTask;
import com.witalis.praxis.leetcode.task.p2.option.*;
import com.witalis.praxis.leetcode.task.p2.content.*;
...
@Slf4j
@LeetCode(id = 2, description = "Add Two Numbers")
