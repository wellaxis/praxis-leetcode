package com.witalis.praxis.leetcode.task.h2.p184;

import com.witalis.praxis.leetcode.task.LeetCodeTask;
import com.witalis.praxis.leetcode.task.h2.p184.option.*;
...
public class DepartmentHighestSalary extends LeetCodeTask<String> {
    ...
    public DepartmentHighestSalary(int id, String description, TaskRevision revision) {
