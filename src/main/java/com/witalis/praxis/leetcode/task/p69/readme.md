# [LeetCode][leetcode] task # 69: [Sqrt(x)][task]
...
[solution]: <https://github.com/wellaxis/witalis-jkit/blob/main/module/tasks/src/main/java/com/witalis/jkit/tasks/core/task/leetcode/p69/option/Practice.java>
